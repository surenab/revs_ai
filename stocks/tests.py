...
class MarketSummaryAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        stock1 = Stock.objects.create(symbol='AAPL', name='Apple Inc.', exchange='NASDAQ')
        stock2 = Stock.objects.create(symbol='GOOGL', name='Alphabet Inc.', exchange='NASDAQ')

        today = date.today()

        # Create price data for market summary
        StockPrice.objects.create(
            stock=stock1, date=today, open_price=Decimal('150.00'),
            high_price=Decimal('155.00'), low_price=Decimal('149.00'),
            close_price=Decimal('153.00'), volume=1000000, interval='1d'
        )
        StockPrice.objects.create(
            stock=stock2, date=today, open_price=Decimal('2500.00'),
            high_price=Decimal('2550.00'), low_price=Decimal('2480.00'),
            close_price=Decimal('2520.00'), volume=500000, interval='1d'
        )
