...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options["symbols"]:
            ...
            msg = "Specify one of: --symbols, --popular, --tech, --biotech, --energy, --finance, --consumer, --industrial, --utilities, --materials, --realestate, --telecom, or --all-sectors"
        ...
        for i in range(0, len(symbols), batch_size):
            ...
            self.stdout.write(
                f"Processing batch {i // batch_size + 1}: {', '.join(batch)}"
            )
    ...
    def _create_stock(self, symbol: str, stock_info: dict) -> bool:
        ...
        if not stock_info:
            self.stdout.write(self.style.ERROR(f"No stock info provided for {symbol}"))
            return False
        ...
        try:
            ...
            logger.exception("Error creating stock %s", symbol)
    ...
    def _format_market_cap(self, market_cap: int) -> str:
        ...
        if market_cap >= 1_000_000:  # Million
