...
import { signalHistoryAPI } from "../../lib/api";
import type { BotSignalHistory } from "../../lib/api";

interface BotSignalHistoryTabProps {
  botId: string;
}
...
const BotSignalHistoryTab: React.FC<BotSignalHistoryTabProps> = ({ botId }) => {
  ...
  const fetchSignals = async () => {
    try {
      setLoading(true);
      const params: Record<string, string> = { bot_id: botId };
...
export default BotSignalHistoryTab;
